...
//         likedBox = document.querySelector('#compare-products-slider .compare-products-list-slider');
...
//         scrollLine.style.width = scrollBar.offsetWidth / (likedBox.offsetWidth / likedCont.offsetWidth) + 'px';
//     } else {
...
//         if(dragCheck) {
//             if(e.clientX - downPos + 12 > scrollBar.offsetLeft && 
//                e.clientX + 12 - downPos + scrollLine.offsetWidth < scrollBar.offsetLeft + scrollBar.offsetWidth) {
